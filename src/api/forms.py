...
class apiAddForm(forms.ModelForm):
    ...
    team = forms.MultipleChoiceField(choices=teams_choices(), required=True, widget=forms.SelectMultiple(attrs={'class':'js-select form-select'}))
...
# class apiEditForm(forms.ModelForm):
#     def teams_choices():
#         value = []
#         team = Team.objects.all()
#         for i in team:
